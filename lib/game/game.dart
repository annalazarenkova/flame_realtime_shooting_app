...
class MyGame extends FlameGame with PanDetector, HasCollisionDetection {
  ...
  Future<void>? onLoad() async {
    final playerImage = await images.load('player.jpg');
    ...
    final opponentImage = await images.load('opponent.jpg');
    _opponent = Player(isMe: false);
    _opponent.add(SpriteComponent.fromImage(opponentImage, size: spriteSize));
    add(_opponent);

    _playerBulletImage = await images.load('player-bullet.jpg');
    _opponentBulletImage = await images.load('opponent-bullet.jpg');
